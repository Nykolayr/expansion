...
- [x] Экран «Новая игра»: сложность → миссия 1
- [x] Экран Progress (локальная статистика гостя)
- [x] Мета-апгрейды: prefs, UI `/upgrades`, влияние на бой
- [x] Подтверждение сброса кампании, выбор вселенной (`UniverKind`, classic в v1)
